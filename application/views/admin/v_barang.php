                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="g_detail" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Gudang" data-width="80%" placeholder="Pilih Kategori" required>
                                <?php foreach ($ged2->result_array() as $g2) {
                                    $id_ged=$g2['gudang_detail_id'];
                                    $nm_ged=$g2['gudang_detail_nama'];
                                    ?>
                                        <option value="<?php echo $id_ged;?>"><?php echo $nm_ged;?></option>
                                <?php }?>
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/barang/edit_barang'?>">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Gudang</label>
                            <div class="col-xs-9">
                                <select name="detail" class="selectpicker show-tick form-control" data-live-search="true" title="Pilih Gudang" data-width="80%" placeholder="Pilih gudang" required>
                                <?php foreach ($ged2->result_array() as $g2) {
                                    $id_ged=$g2['gudang_detail_id'];
                                    $nm_ged=$g2['gudang_detail_nama'];
                                    if($id_ged==$ged_id)
                                        echo "<option value='$id_ged' selected>$nm_ged</option>";
                                     else
                                        echo "<option value='$id_ged'>$nm_ged</option>";
