   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data
                    <small>Vendor</small>
                    <div class="pull-right"><a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#largeModal"><span class="fa fa-plus"></span> Tambah Vendor</a></div>
                </h1>
            </div>
        </div>
        <!-- /.row -->
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        ...
                        $id=$a['vendor_id'];
                        $nm=$a['vendor_nama'];
                        $alamat=$a['vendor_alamat'];
                        $notelp=$a['vendor_notelp'];
                ?>
                    <tr>
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/vendor/tambah_vendor'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Vendor</label>
                        <div class="col-xs-9">
                            <input name="nama" class="form-control" type="text" placeholder="Nama Vendor..." style="width:280px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/vendor/edit_vendor'?>">
                        <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Vendor</label>
                        <div class="col-xs-9">
                            <input name="nama" class="form-control" type="text" placeholder="Nama Vendor..." value="<?php echo $nm;?>" style="width:280px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalHapusPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="modal-title" id="myModalLabel">Hapus Vendor</h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/vendor/hapus_vendor'?>">
                        <div class="modal-body">
